      ...
      <section className="bg-black">
        <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
          <form className="w-full max-w-md" onSubmit={handleLogin}>
            ...
            {errorMessage && (
              <p className="mt-4 text-white bg-red-500 p-2 text-center rounded-lg">
                {"User not exist"}
              </p>
            )}
            <div className="relative flex items-center mt-8">
              ...
              <input
                type="email"
                className="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 "
                placeholder="Email"
                value={email}
            ...
            <div className="relative flex items-center mt-4">
              ...
              <input
                type="password"
                className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600"
